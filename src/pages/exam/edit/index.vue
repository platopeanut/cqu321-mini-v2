<template>
  <Form>
    ...
    <PickerInput title="日期" type="date" v-model:value="examInfo.date" />
    <PickerInput title="开始时间" type="time" v-model:value="examInfo.startTime" />
    <PickerInput title="结束时间" type="time" v-model:value="examInfo.endTime" />
...
<script setup lang="ts">
  ...
  import PickerInput from "@/pages/components/form/PickerInput.vue";
